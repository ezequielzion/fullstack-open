...
test("renders content", () => {
  ...
  const { container } = render(<Blog blog={blog} addLike={mockHandler} deleteBlog={mockHandler} user={{}} />);
...
test("clicking the button calls event handler once", async () => {
  ...
  render(<Blog blog={blog} addLike={mockHandler} deleteBlog={mockHandler} user={{ name: "pepo", username: "pepe" }} />);
