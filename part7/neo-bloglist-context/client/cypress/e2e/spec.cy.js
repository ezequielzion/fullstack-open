  ...
  describe("Login", function () {
    ...
    describe("When logged in", function () {
      ...
      it("User can like blogs", function () {
        ...
        cy.get("#likes").invoke("text").should("contain", "0");
        cy.contains("button", "Like").click();
        cy.get("#likes").invoke("text").should("contain", "1");
      });
      ...
      it("blogs are ordered based on likes", async function () {
        ...
        cy.contains("Second most likes").parent().contains("button", "Show").click();
        cy.contains("Second most likes").parent().parent().contains("button", "Like").as("2ndButton");
        cy.contains("Second most likes").parent().parent().get("#likes").invoke("text").as("2ndLikeText");
        ...
        cy.contains("Third most likes").parent().contains("button", "Show").click();
        cy.contains("Third most likes").parent().parent().contains("button", "Like").as("3rdButton");
        cy.contains("Third most likes").parent().parent().get("#likes").invoke("text").as("3rdLikeText");
        ...
        cy.contains("Most likes").parent().contains("button", "Show").click();
        cy.contains("Most likes").parent().parent().contains("button", "Like").as("1stButton");
        cy.contains("Most likes").parent().parent().get("#likes").invoke("text").as("MostLikeText");
