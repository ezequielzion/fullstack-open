...
const App = () => {
  ...
  const indexOfMostVoted = points.indexOf(maxVotes);
  ...
  const voteForAnecdote = () => {
    const pointsDuplicate = [...points]
    pointsDuplicate[selected]+=1
    setPoints(pointsDuplicate)
  }
